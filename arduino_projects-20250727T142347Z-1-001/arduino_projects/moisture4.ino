...
void loop() {
  ...
  } else if (soilmoisturepercent > 10) {
    // Stop the relay if moisture is above 10%
    Serial.println("Moisture is above 10%, stopping the relay");
    display.print("Moisture is above 10%, stopping the relay");
    digitalWrite(relay_pin, LOW);   // Turn off the relay
  }
