...
void loop() {
  ...
  if (soilmoisturepercent < 10) {
    ...
    // Moisture is 10% or greater, stop the relay
    Serial.println("Moisture is 10% or greater, stopping the relay");
    display.print("Moisture is 10% or greater, stopping the relay");
    digitalWrite(relay_pin, LOW);   // Turn off the relay
  }
